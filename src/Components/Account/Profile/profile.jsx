      ...
      fetch("https://orchestration.trackdsa.in/user/verifyaccess", {
        ...
        .then((data) => {
          if (data.accessToken !== false) {
            ...
            fetch(`https://orchestration.trackdsa.in/user/getprofile/${data.userid}`)
              .then(async (response) => {
                if (response.status >= 200 && response.status <= 299) {
                  return response.json();
                } else {
      ...
      fetch("https://orchestration.trackdsa.in/user/verifyaccess", {
        ...
        .then((data) => {
          if (data.accessToken !== false) {
            ...
            fetch(
              `https://orchestration.trackdsa.in/user/updateprofile/${data.userid}`,
              {
                method: "PUT",
      ...
      fetch("https://orchestration.trackdsa.in/user/verifyaccess", {
        ...
        .then((data) => {
          if (data.accessToken !== false) {
            ...
            fetch(
              `https://orchestration.trackdsa.in/user/validateusername/${form.getFieldValue(
                "username"
              )}`
            )
              .then(async (response) => {
