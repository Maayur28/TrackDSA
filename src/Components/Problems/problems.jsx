      ...
      fetch("https://trackdsauser.azurewebsites.net/verifyaccess", {
        ...
        .then((data) => {
          if (data.accessToken !== false) {
            ...
            fetch(
              `https://trackdsa.azurewebsites.net/getproblems/${data.userid}`
            )
              .then(async (response) => {
                if (response.status >= 200 && response.status <= 299) {
                  return response.json();
      ...
      .then((data) => {
        if (data.accessToken !== false) {
          ...
          if (editMode) {
            ...
            values.note = note;
            fetch("https://trackdsa.azurewebsites.net/editproblem", {
              method: "PUT",
            ...
            fetch("https://trackdsa.azurewebsites.net/addproblem", {
              method: "POST",
    ...
    fetch("https://trackdsauser.azurewebsites.net/verifyaccess", {
      ...
      .then((datas) => {
        if (datas.accessToken !== false) {
          ...
          fetch("https://trackdsa.azurewebsites.net/deleteproblem", {
            method: "DELETE",
            body: JSON.stringify(obj),
            headers: {
              "Content-type": "application/json; charset=UTF-8",
    ...
    fetch("https://trackdsauser.azurewebsites.net/verifyaccess", {
      ...
      .then((datas) => {
        if (datas.accessToken !== false) {
          ...
          if (array.length > 0) {
            fetch("https://trackdsa.azurewebsites.net/sendmail", {
              method: "POST",
